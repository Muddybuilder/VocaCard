 ...
 * @author user
 */
public class KeyBoxController implements Initializable {
    @FXML
    private VBox root;
    @FXML
...
//                    System.out.println(handlekey);
        ...
        tfield.setPrefHeight(root1.getHeight()-10);
    ...
    public void setAutoSize(Pane parent){
        ...
        double hrate = 230*(w-16)/667+40;
        double rate = (w-16)/667;
...
//                        System.out.println(dc);
    ...
    public void setDisable(boolean val){
        root.setDisable(val);
        root.setOpacity(1);
        if (val) root.setOpacity(0.68);
        
        root1.setStyle("-fx-fill: white;");
        if (val) root1.setStyle("-fx-fill: #e0dddd;");
